...
let skillSettings = {
    "HTML": { width: "80%", background: "linear-gradient(0deg, #e44d26, #f16529, #f4f4f4)" },
    "CSS": { width: "60%", background: "linear-gradient(0deg, #0478be, #009fe4, #f4f4f4)" },
    "Javascript": { width: "50%", background: "linear-gradient(0deg, #f7df1e, #0a0a0a)" },
    ...
    "Git": { width: "60%", background: "linear-gradient(0deg, #f1502f, #ffffff)" },
    "GitHub": { width: "60%", background: "linear-gradient(0deg, #d3d3d3, #404040, #808080)" }
};
